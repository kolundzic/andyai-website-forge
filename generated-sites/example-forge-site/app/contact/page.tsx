  ...
  return (
    <main className="min-h-screen px-6 py-12 md:px-12">
      <section className="mx-auto max-w-5xl rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm">
        ...
        <h1 className="mt-4 text-4xl font-bold tracking-tight text-zinc-950">Contact</h1>
        <p className="mt-4 text-lg leading-8 text-zinc-700">Simple contact route placeholder.</p>
